...
export const CONTENT = {
  en: {
    ...
    portfolio: {
      ...
      roleLabel: 'Role',
      expandLabel: 'View full case study',
      ...
      projects: [
        {
          ...
          image: '/portfolio/airport.webp',
          sector: 'Government · Border control',
          role: 'Full-stack development & system architecture',
          summary: 'A paper-based migration agency went from zero digital infrastructure to a real-time control dashboard in 10 days.',
          problem: 'A government migration agency was running border control entirely on paper logs and manual spreadsheets. Passenger tracking was slow, error-prone, and impossible to audit — causing checkpoint delays, lost records, and zero real-time visibility for the supervisors who needed to make fast decisions.',
          solution: 'We architected a full-stack MVP with a React dashboard, a Node.js/Express API, and MongoDB for flexible passenger and checkpoint records. Role-based access separated officers, supervisors, and admins, while a real-time data layer fed live passenger-flow, nationality-distribution, and active-alert widgets. AI-assisted development took us from architecture to a working prototype in 10 days.',
          impact: 'The agency replaced paper with a live operational picture: supervisors could see checkpoint load and alerts as they happened, processing sped up dramatically, and data accuracy stopped depending on handwriting. The MVP became the foundation for a production rollout.',
          metrics: [
        ...
        },
        {
          ...
          image: '/portfolio/ai-landing.webp',
          sector: 'SaaS · Lead generation',
          role: 'Product engineering & AI integration',
          summary: 'An AI tool that turns a short brief into a conversion-optimized, deploy-ready landing page in minutes.',
          problem: 'Small businesses were paying $3K–$10K and waiting weeks for landing pages — with no guarantee any of them would actually convert. The cost and lead time priced out exactly the businesses that needed leads the most.',
          solution: 'We built an AI-powered generator on React + Vite + Tailwind that produces a full landing page — copywriting, responsive layout, and CTAs — from a short brief. Conversion best practices are baked into the templates, and a one-click deploy ships the result straight to production.',
          impact: 'Page creation dropped from weeks to under five minutes at roughly a tenth of agency cost, while the conversion-first templates held a 4.2% average conversion rate — making professional landing pages viable for budgets that could never reach an agency.',
          metrics: [
        ...
        },
        {
          ...
          image: '/portfolio/agrocontrol.webp',
          sector: 'AgTech · Farm operations',
          role: 'Full-stack development & data architecture',
          summary: 'A 50-hectare farm replaced six disconnected spreadsheets with one real-time operations platform.',
          problem: 'A farming operation managing 50+ hectares ran everything on six disconnected spreadsheets. Harvest cycles, per-lot costs, and worker assignments lived in separate files that never reconciled — so the team was always guessing at real margins and losing track of what each lot actually cost.',
          solution: 'We delivered a full management platform with real-time dashboards, per-lot cost tracking, and harvest-cycle analytics, built on a JavaScript/Express/MongoDB stack with Chart.js visualizations. A single data model replaced the six spreadsheets, giving every cost and cycle one source of truth.',
          impact: 'The operation reached 100% digital adoption and gained clear per-lot cost visibility for the first time, turning guesswork into decisions backed by live data — all delivered in two weeks.',
          metrics: [
    ...
    offers: {
      ...
      descriptionSuffix: '.',
      oneTime: 'One-time project. Request a quote — no commitment.',
  ...
  es: {
      ...
      projects: [
        {
          name: 'Airport Management MVP',
          image: '/portfolio/airport.webp',
          sector: 'Gobierno · Control migratorio',
          role: 'Desarrollo full-stack y arquitectura del sistema',
          summary: 'Una agencia migratoria en papel pasó de cero infraestructura digital a un dashboard de control en tiempo real en 10 días.',
          problem: 'Una agencia gubernamental de migración gestionaba el control fronterizo íntegramente con registros en papel y hojas de cálculo manuales. El seguimiento de pasajeros era lento, propenso a errores e imposible de auditar — generando retrasos en los puntos de control, pérdida de registros y cero visibilidad en tiempo real para los supervisores que debían tomar decisiones rápidas.',
          solution: 'Diseñamos un MVP full-stack con un dashboard en React, una API en Node.js/Express y MongoDB para registros flexibles de pasajeros y puntos de control. El acceso por roles separó a oficiales, supervisores y administradores, mientras una capa de datos en tiempo real alimentaba los widgets de flujo de pasajeros, distribución por nacionalidad y alertas activas. El desarrollo asistido por IA nos llevó de la arquitectura a un prototipo funcional en 10 días.',
          impact: 'La agencia reemplazó el papel por una imagen operativa en vivo: los supervisores podían ver la carga de cada punto de control y las alertas en el momento, el procesamiento se aceleró drásticamente y la precisión de los datos dejó de depender de la escritura a mano. El MVP se convirtió en la base para un despliegue en producción.',
          metrics: [
        ...
        },
        {
          name: 'AI Landing Generator',
          image: '/portfolio/ai-landing.webp',
          sector: 'SaaS · Generación de leads',
          role: 'Ingeniería de producto e integración de IA',
          summary: 'Una herramienta de IA que convierte un brief corto en una landing optimizada para conversión y lista para desplegar en minutos.',
          problem: 'Las pequeñas empresas pagaban $3K–$10K y esperaban semanas por una landing page — sin garantía de que alguna convirtiera. El costo y los tiempos dejaban fuera justo a los negocios que más necesitaban leads.',
          solution: 'Construimos un generador con IA sobre React + Vite + Tailwind que produce una landing completa — copy, diseño responsivo y CTAs — a partir de un brief corto. Las mejores prácticas de conversión vienen integradas en las plantillas, y un deploy con un clic lleva el resultado directo a producción.',
          impact: 'La creación de páginas bajó de semanas a menos de cinco minutos a cerca de la décima parte del costo de una agencia, mientras las plantillas orientadas a conversión sostuvieron un 4.2% de tasa de conversión promedio — haciendo viables las landings profesionales para presupuestos que jamás llegarían a una agencia.',
          metrics: [
        ...
        },
        {
          name: 'AgroControl Platform',
          image: '/portfolio/agrocontrol.webp',
          sector: 'AgTech · Operaciones agrícolas',
          role: 'Desarrollo full-stack y arquitectura de datos',
          summary: 'Una finca de 50 hectáreas reemplazó seis hojas de cálculo desconectadas por una sola plataforma de operaciones en tiempo real.',
          problem: 'Una operación agrícola que gestionaba más de 50 hectáreas llevaba todo en seis hojas de cálculo desconectadas. Los ciclos de cosecha, los costos por lote y la asignación de trabajadores vivían en archivos separados que nunca cuadraban — así que el equipo siempre adivinaba los márgenes reales y perdía el rastro de cuánto costaba realmente cada lote.',
          solution: 'Entregamos una plataforma de gestión completa con dashboards en tiempo real, seguimiento de costos por lote y análisis de ciclos de cosecha, sobre un stack JavaScript/Express/MongoDB con visualizaciones en Chart.js. Un único modelo de datos reemplazó las seis hojas de cálculo, dando a cada costo y ciclo una sola fuente de verdad.',
          impact: 'La operación alcanzó 100% de adopción digital y obtuvo por primera vez visibilidad clara de costos por lote, convirtiendo la adivinación en decisiones respaldadas por datos en vivo — todo entregado en dos semanas.',
          metrics: [
    ...
    offers: {
      ...
      descriptionSuffix: '.',
      oneTime: 'Proyecto único. Solicita cotización — sin compromiso.',
